...
src/
  ...
  server/               # Web server (feature-gated behind "serve")
    ...
    state.rs            # AppState (db path, session token, build features, unlock gate)
    ...
    routes/
      ...
      imports.rs        # GET /api/imports, GET /api/csv-profiles, DELETE /api/imports/:id
