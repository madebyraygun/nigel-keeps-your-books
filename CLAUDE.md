  ...
  packages/
    ...
    ui/                 # @nigel/ui — wc-* components + preview harness
      src/components/   # wc-app-shell, wc-nav-sidebar, wc-toast, wc-confirm, wc-money,
                        #   wc-empty-state, wc-spinner, wc-panel, the register, review and
                        #   import families, wc-category-picker (each with .preview.ts + .test.ts)
