...
src/
  ...
  server/               # Web server (feature-gated behind "serve")
    ...
    routes/
      mod.rs            # API router; GET /api/ping, JSON 404 fallback, guarded data_router()
